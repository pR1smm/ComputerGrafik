...
# Template: app
# Command: E:\Qt\5.7\mingw53_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile ModelsTextured.pro
#############################################################################
...
QMAKE         = E:\Qt\5.7\mingw53_32\bin\qmake.exe
DEL_FILE      = del
